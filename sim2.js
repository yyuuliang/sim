...
net.createServer(function(socket){
    ...
    socket.on('data', function(data){
		...
		inString = inString.toString().trim();
...
/////////////////////////////////////////////////////
			...
			case 'ATSH7E0':    ecu = 0x7e8;    socket.write("OK\r\r>"); break;
			case 'ATSH7E1':    ecu = 0x7e9;    socket.write("OK\r\r>"); break;
			case 'ATSH7E2':    ecu = 0x7ea;    socket.write("OK\r\r>"); break;
			case 'ATSH7E3':    ecu = 0x7eb;    socket.write("OK\r\r>"); break;
			case 'ATSH7E4':    ecu = 0x7ec;    socket.write("OK\r\r>"); break;
			case 'ATSH7E5':    ecu = 0x7ed;    socket.write("OK\r\r>"); break;
			case 'ATSH7DF':    ecu = 0;        socket.write("OK\r\r>"); break;
...
/////////////////////////////////////////////////////
			...
			console.log("111:",noRstring);			
			break;


			case '0104':    // engine load from taho
			socket.write("410408\r\r>");
			break;


			case '0105':   // engine coolant tmep
			...
			*/
			...
			case '0106':   // fuel trim short 1
			socket.write("410680\r\r>");   // taho
			break;



			case '0107':   // fuel trim long 1
			socket.write("41077E\r\r>");   // taho
			break;

			case '0108':   // fuel trim short 2
            socket.write("410882\r\r>");   // taho
            
			break;

			case '0109':   // fuel trim long 2
			...
			*/
			...
			case '010F':   // intake air tmep
			socket.write("410F4A\r\r>");   // vibe
			break;


			case '0110':   // MAF air flow
			...
			case '0114':   // Oxygen sensors 
				socket.write("41141A82\r\r>");   // taho
				break;
			case '0115':   // Oxygen sensors 
				socket.write("411521FF\r\r>");   // taho
				break;
			case '0116':   // Oxygen sensors 
				socket.write("41141A82\r\r>");   // taho
				break;
			case '0117':   // Oxygen sensors 
				socket.write("41141A82\r\r>");   // taho
				break;
			case '0118':   // Oxygen sensors 
				socket.write("41182383\r\r>");   // taho
				break;
			case '0119':   // Oxygen sensors 
				socket.write("41192EFF\r\r>");   // taho
				break;
			case '011A':   // Oxygen sensors 
				socket.write("41141A82\r\r>");   // taho
				break;
			case '011B':   // Oxygen sensors 
				socket.write("41141A82\r\r>");   // taho
				break;



			case '011C':   // OBD standards this vehicle conforms to
				socket.write("411C01\r\r>");   // taho
				break;

			case '011D':   // o2 sensors present
			...
			case '011F':   // run time in seconds since start
